...
<b>Правила:</b>
- Ставьте реакції на повідомлення, деякі позитивні реакції збільшують рейтинг на 25, деякі негативні зменшують на 18.
- Ви не можете змінювати рейтинг собі

<b>Використання казино: /casino <i>bet</i></b>, де bet від 5-25 (без вказання - 5))
