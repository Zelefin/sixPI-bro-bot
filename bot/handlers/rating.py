...
- <b>🦄Гетьмани</b> можуть змінювати/встановлювати собі та всім хто нижче Отаманів кастомні титули. Мають доступ до моделей gpt-4o та claude 3.5 sonnet.
- <b>🐘Отамани</b> можуть встановлювати кастомні титули тільки собі.
- <b>🐥Козаки</b> є доступ до моделей gpt-3.5-turbo та claude 3 haiku.
...
<b>Використання казино:</b> <pre>/casino bet</pre> де bet від 1-10 (без вказання - 1))
<b>Таблиця виграшів /casino:</b>
- 3X BAR коефіцієнт виграшу 7
- 🍇🍇🍇 коефіцієнт виграшу 10
- 🍋🍋🍋 коефіцієнт виграшу 15
🔥ДЖЕКПОТ🔥 коефіцієнт виграшу 20
"""
