...
Згенеруй випадковий жарт про академічну доброчесність студента. Врахуй отриманий відсоток. Також для контексту знай - ти в групі студентів спеціальності "Інженерія програмного забезпечення" a.k.a програмістів. Можеш враховувати це при генерації жарта.
